  ...
  if (current_voltage < 3.5f) {
    ...
    if (lora_status == LORA_OK) {
      ...
      if (SHT30_ReadSensor(&currentReading) == HAL_OK) {
        ...
        sensor_data.cap_voltage = (uint16_t)(current_voltage * 100.0f);
        ...
        /* -------------------------------------------------------------- */
        uint8_t tx_size =
            offsetof(lora_packet_t, payload) + tx_packet.payload_length;
        ...
        if (lora_status == 1) {
          ...
          printf("Cap Voltage : %.2f V\r\n",
                 (float)sensor_data.cap_voltage / 100.0f);
          printf("\r\n======================================\r\n\r\n");
          ...
          printf("\r\n[ERROR] LoRa TX Timeout! (TxDone was never set by the "
                 "module)\r\n\r\n");
        }
      } else {
        /* Sensor Read Failed */
    ...
    Power_DeepSleep(&hrtc,
                    180); // Long sleep until next scheduled reading (30 mins)
  }
